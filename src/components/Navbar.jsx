...
export default function Navbar() {
  ...
  const hideNav = ["/login", "/booking-success"].includes(
    location.pathname
  );
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-emerald-900/5 shadow-sm">
        ...
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            ...
            <div className="w-9 h-9 rounded-xl bg-[#0a7a53] flex items-center justify-center text-white shadow-sm transition-transform group-hover:scale-105 overflow-hidden">
              ...
              <span className="hidden text-base items-center justify-center w-full h-full">
                ✨
              </span>
          ...
          >
            ...
            <button
              ...
              className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all shadow-sm font-poppins ${
                dropdownOpen
                  ? "ring-2 ring-[#0a7a53] ring-offset-2"
                ...
                <div className="px-4 py-3 bg-[#e6f4ef]/50 border-b border-emerald-900/5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span
                        className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider font-poppins ${
                          user.role === "admin"
      ...
      {/* ── Bottom Pill Nav ──
          Hidden completely for admin users
      ── */}
